'''
#######################################################################################################
Stuxnet Risk Assessment using Bayesian Belief Networks (BBN) based on AutomationML Models
...
if __name__ == "__main__":
    ...
    source_node, target_node = find_shortest_path(bbn_exposure, valid_nodes, "User", "Centrifuge_Failure")
